    ...
    <div class="uk-container uk-margin">
        <div class="uk-child-width-auto uk-flex-middle uk-flex-between" uk-grid>
            <div class="uk-width-1-2 uk-width-auto@m">
                <h1 class="video-title uk-text-uppercase">Video</h1>
            </div>
            ...
            <div class="uk-width-expand">
                <form class="uk-search uk-search-default uk-width-1-1 tv-search">
                    ...
                    <input class="uk-search-input" type="search" placeholder="Tìm kiếm video...">
                </form>
            </div>
        </div>
    </div>
    <div class="uk-container">
        <div class="uk-child-width-1-4@m uk-child-width-1-5@l uk-grid-small" uk-grid>
            <?php
            $data = array(
                array(
